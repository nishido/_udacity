...
the_shawshank_redemption = media.Movie(
                ...
                ("A man is falsely imprisoned for the"
                 " murder of his wife"),
...
pulp_fiction = media.Movie(
                ...
                ("An inter-twining tale of theft, drugs and amazing"
                 " dialogue!"),
                "https://upload.wikimedia.org/wikipedia/en/8/82/Pulp_Fiction_cover.jpg",  # noqa
                "https://www.youtube.com/watch?v=s7EdQ4FqbhY")

back_to_the_future = media.Movie(
                "Back to the Future",
                ("A teenager travels back to 1955 with the"
                 " help of an eccentric physicist"),
...
# forming a list out of the above movie objects
movies = [the_shawshank_redemption, back_to_the_future, pulp_fiction,
          finding_nemo, forest_gump, the_matrix]

# passing the above list through the external rendering function
